...
void
l1t::MuonRawDigiTranslator::fillMuon(Muon& mu, uint32_t raw_data_spare, uint32_t raw_data_00_31, uint32_t raw_data_32_63, int fed, unsigned int fw, int muInBx)
{
...
void
l1t::MuonRawDigiTranslator::fillIntermediateMuon(Muon& mu, uint32_t raw_data_00_31, uint32_t raw_data_32_63, unsigned int fw)
{
  // Need the hw charge to properly compute dPhi
  mu.setHwCharge((raw_data_32_63 >> chargeShift_) & 0x1);
...
void
l1t::MuonRawDigiTranslator::fillMuonStableQuantities(Muon& mu, uint32_t raw_data_00_31, uint32_t raw_data_32_63)
{
...
void
l1t::MuonRawDigiTranslator::fillMuon(Muon& mu, uint32_t raw_data_spare, uint64_t dataword, int fed, unsigned int fw, int muInBx)
{
  fillMuon(mu, raw_data_spare, (uint32_t)(dataword & 0xFFFFFFFF), (uint32_t)((dataword >> 32) & 0xFFFFFFFF), fed, fw, muInBx);
}
