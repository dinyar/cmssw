...
void L1TStage2uGMT::bookHistograms(DQMStore::IBooker& ibooker, const edm::Run&, const edm::EventSetup&) {
  ...
  if (!emul) {
    ...
    ugmtBMTFhwPtUnconstrained = ibooker.book1D("ugmtBMTFhwPtUnconstrained", "uGMT BMTF Input HW p_{T} unconstrained", 512, -0.5, 511.5);
  ...
  ugmtMuonhwPtUnconstrained = ibooker.book1D("ugmtMuonhwPtUnconstrained", "uGMT Muon HW p_{T} unconstrained", 512, -0.5, 511.5);
