...
void L1TStage2uGMTMuon::bookHistograms(DQMStore::IBooker& ibooker, const edm::Run&, const edm::EventSetup&) {
  ...
  ugmtMuonhwPtUnconstrained = ibooker.book1D("ugmtMuonhwPtUnconstrained", (titlePrefix+"HW p_{T} unconstrained").c_str(), 256, -0.5, 255.5);
  ...
  ugmtMuonPtUnconstrained = ibooker.book1D("ugmtMuonPtUnconstrained", (titlePrefix+"p_{T} unconstrained").c_str(), 128, -0.5, 255.5);
